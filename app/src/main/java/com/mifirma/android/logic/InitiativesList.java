...
final class InitiativesList {
    ...
    private final ArrayList<Initiative> initiatives = new ArrayList<>();
    ...
    static InitiativesList getInitiativesList(Context context) throws IOException, DOMException, ParseException {
        ...
        if (!MainActivity.DEBUG) {
            xmlBytes = UrlHttpManagerFactory.getInstalledManager().readUrl(urlStr, -1, "application/xml", "text/xml", UrlHttpMethod.GET);
        }
        else {
